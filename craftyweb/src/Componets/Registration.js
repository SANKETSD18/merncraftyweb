...
const Help = () => {
    ...
    const submit = async (event) => {
        ...
        } else if (password.length < 8 && cwrpassword.length < 8) {
            ...
            <div className='text-center col-lg-12 '>
                <form className='text-center px-5 col-12 ' method='POST' autoComplete="off" onSubmit={submit} style={{
                    ...
                    <div className="form-group">
                        ...
                        <input className="form-control mb-4  text-center" type="text" name="name" id="name" value={user.name}
                            onChange={inputs} />
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" onChange={inputs} name='phone' value={user.phone} className="form-control mb-4 text-center" />
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" onChange={inputs} name='cwrpassword' value={user.cwrpassword} className="form-control  text-center" />
                    </div>
